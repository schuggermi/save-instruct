...
ActiveRecord::Schema[7.0].define(version: 2022_09_01_125441) do
  ...
  create_table "employee_tasks", force: :cascade do |t|
    t.datetime "task_done", precision: nil
  ...
  create_table "nfcs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["task_id"], name: "index_nfcs_on_task_id"
  end
